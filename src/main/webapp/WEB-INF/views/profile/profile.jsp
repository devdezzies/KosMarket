                        ...
                        <div id="sidebarMenus" class="space-y-8 transition-all duration-300 ease-in-out">
                            ...
                            <div>
                                ...
                                <div class="mb-8">
                                    ...
                                    <nav class="space-y-2">
                                        <a href="?page=me" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg
                                            <%= " me".equals(pageParam) ? "bg-gray-100 text-gray-900"
                                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-50" %>">
                                            <svg class="w-5 h-5 mr-3 <%= " me".equals(pageParam) ? "text-gray-500"
                                                : "text-gray-400" %>"
                                        ...
                                        <a href="?page=products" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg
                                            <%= " products".equals(pageParam) ? "bg-gray-100 text-gray-900"
                                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-50" %>">
                                            <svg class="w-5 h-5 mr-3 <%= " products".equals(pageParam) ? "text-gray-500"
                                                : "text-gray-400" %>"
                                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <a href="?page=location" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg
                                            <%= " location".equals(pageParam) ? "bg-gray-100 text-gray-900"
                                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-50" %>">
                                    ...
                                    <% } else if (pageParam.equals("location")) { %>
                                        ...
                                        <% } else if (pageParam.equals("edit_product")) { %>
                                            <jsp:include page="/WEB-INF/includes/UI/profile/edit_product.jsp" />
                                                <% } else { %>
                                                    <div class="text-center text-gray-500 py-8">Halaman tidak ditemukan.
                                                    </div>
                                                    <% } %>
                        </div>
                    </main>
