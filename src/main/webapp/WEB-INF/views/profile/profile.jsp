...
<head>
    <title>Profile Settings - KosMarket</title>
    ...
    <aside class="w-64 bg-white border-r border-gray-200 px-6 py-8">
        ...
        <div>
            ...
            <nav class="space-y-2">
                ...
                <a href="#" class="flex items-center px-3 py-2 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg">
    ...
    <main class="flex-1 px-8 py-8">
        <div class="max-w-2xl">
            ...
            <form class="space-y-6">
                ...
                <!-- Phone Number -->
                <div>
                    <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">Number</label>
                    <input type="tel"
                           id="phone"
                           name="phone"
